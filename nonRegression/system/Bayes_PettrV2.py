...
from switch_controller import switch_ctrl
import numpy as np
...
def compare(example_1, example_2):
	...
	anim.save('gifs/surveil_error.gif', writer='imagemagick')
...
# v20210225 v2
	i=0
	logger.logger.info('# PetterExample V2')
